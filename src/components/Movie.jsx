...
const Movie = ({ img, title, releaseDate, overview, lang, voteCount, voteAvg, popularity, setInfo }) => {
    ...
    return (
        <Link to="/details" className="mx-5 my-3 w-36 h-72 p-1 flex flex-col justify-start items-center break-normal hover:scale-110 duration-[1s] shadow-sm shadow-gray-500 rounded-xl" onClick={handleClick}>
